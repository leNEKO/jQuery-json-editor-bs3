...
(function ($) {
    ...
    var JsonEdit = $.fn.jsonEdit = function (opt_options) {
        ...
        self.createGroup = function (field) {
            ...
            // TODO Configurable
            // Add label
            $group.find(".json-label").append(self.labels[field.type].clone(true).text(field.label));
           ...
           if (fieldData === undefined) { return; }
            ...
            if (field.type == "array") {
                ...
                var $tbody = null;
                var $headers = null;
                $input = $("<table class='table json-edit-table'>", {
    ...
    JsonEdit.labels = {
        ...
        "regexp": def_label,
        "date": def_label,
        "object": $("<h4 class='text-uppercase'>"),
        "array": $("<h4 class='text-uppercase'>")
    };
